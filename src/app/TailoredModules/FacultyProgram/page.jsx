        ...
        <div className="mx-auto container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
            ...
            <div className="space-y-4 lg:space-y-6">
              <h2 className="h-blue">
                Build a faculty that believes, belongs, and becomes.
              </h2>
            </div>
            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              FacultyFirst™ strengthens your internal culture by connecting your educators to your brand purpose, making them your strongest ambassadors.
              </h6>
            </div>
          </div>
        </div>
            ...
            <div className="lg:w-1/2 space-y-10 mt-12 lg:top-50">
              ...
              <div>
                ...
                <h6 className="mt-4 text-xl sm:text-2xl lg:text-3xl font-black text-[#002855] leading-snug">
                 Institutions seeking stronger<br/> faculty engagement and retention.
              ...
              <div>
                ...
                <h6 className="mt-4 text-xl sm:text-2xl lg:text-3xl font-black text-[#002855] leading-snug">
                     Disconnected, undervalued faculty<br className="hidden sm:block" /> with low emotional buy-in.
                </h6>
              </div>
          ...
          <div className="relative w-full  overflow-hidden min-h-[250px] md:min-h-[300px] md:pl-45">
            ...
            <div className="relative z-20 px-6 sm:px-8 md:px-12 lg:px-16 py-12 md:py-16 lg:py-20">
              ...
              <h3 className="text-[28px] sm:text-[32px] lg:text-[40px] text-white font-medium leading-tight">
                Faculty who feel<br/> valued, proud, and aligned with your institution’s mission.
              </h3>
            </div>
          </div>
        </div>
